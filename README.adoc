= Neo4j Postgres integration [![CI](https://github.com/sim51/neo4j-fdw/actions/workflows/test.yml/badge.svg)](https://github.com/sim51/neo4j-fdw/actions/workflows/test.yml)
